...
public class ListTester {
	...
	private void runTests() {
		...
		testThreeElementList(BC_addToFrontA_ABC, "BC_addToFrontA_ABC", LIST_ABC, STRING_ABC);
		//2-element to changed 2-element via set()
		testTwoElementList(BA_set1C_BC, "BA_set1C_BC", LIST_BC, STRING_BC);
		//3-element to 2-element
		testTwoElementList(ABC_remove0_BC, "ABC_remove0_BC", LIST_BC, STRING_BC);
		//3-element to changed 3-element
		testThreeElementList(ABC_set1D_ADC, "ABC_set1D_ADC", LIST_ADC, STRING_ADC);
		//4-element to 3-element
		testThreeElementList(ABCD_remove3_ABC, "ABCD_remove3_ABC", LIST_ABCD, "ABCD");
		//1-element to empty list using iterator
		testEmptyList(A_IterRemoveA_empty, "A_IterRemoveA_empty");
		//2-element to 1-element using iterator
		...
		//3-element to 2-element using iterator
		...
		//3-element to 2-element using iterator
		testTwoElementList(ABC_iterRemove_BC, "ABC_iterRemove_BC", LIST_BC, STRING_BC);
		//3-element to 1-element
		testSingleElementList(ABC_removeFirst_removeLast_B, "ABC_removeFirst_removeLast_B", LIST_B, STRING_B);
		//3-element to 1-element
		testSingleElementList(ABC_removeFirst_iterRemove_C, "ABC_removeFirst_iterRemove_C", LIST_C, STRING_C);
		//3-element to 2-element
		testTwoElementList(ABC_NextPreviousRemove_BC, "ABC_NextPreviousRemove_BC", LIST_BC, STRING_BC);
		//3-element to 3-element
		testThreeElementList(ABC_NextNextSetD_ADC, "ABC_NextNextSetD_ADC", LIST_ADC, STRING_ADC);
		//2-element to 2-element
		testTwoElementList(BA_NextNextSetC_BC, "BA_NextNextSetC_BC", LIST_BC, STRING_BC);
		//1-element to 2-element
		testTwoElementList(B_NextAddA_BA, "B_NextAddA_BA", LIST_BA, STRING_BA);
		//3-element to 2-element
		testTwoElementList(ABC_NextNextPreviousRemove_AC, "ABC_NextNextPreviousRemove_AC", LIST_AC, STRING_AC);
	...
	private IndexedUnsortedList<Integer> ABList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToRear(ELEMENT_B);
		return list;
	}
	
	private IndexedUnsortedList<Integer> ABCDList() {
	...
	private IndexedUnsortedList<Integer> BC_addToFrontA_ABC() {
		IndexedUnsortedList<Integer> list = BA_set1C_BC();
		list.addToFront(ELEMENT_A);
		return list;
	}
	private Scenario<Integer> BC_addToFrontA_ABC = () -> BC_addToFrontA_ABC();
	
	/** Scenario: [BA] -> set(1, C) -> [BC]
	 * @return [BC] after set(1, C)
	 */
	private IndexedUnsortedList<Integer> BA_set1C_BC() {
		IndexedUnsortedList<Integer> list = A_addToFrontB_BA();
		list.set(1, ELEMENT_C);
		return list;
	}
	private Scenario<Integer> BA_set1C_BC = () -> BA_set1C_BC();
	
	/** Scenario: [ABC] -> remove(0) -> [BC]
	...
	/** Scenario: [AB] -> IterRemove(A) -> [B]
	 * @return [B] after IterRemove(A)
	 */
	private IndexedUnsortedList<Integer> AB_IterRemoveA_B() {
		IndexedUnsortedList<Integer> list = ABList();
		Iterator<Integer> it = list.iterator();
		it.next();
		it.remove();
		return list;
	...
	/** Scenario: [AB] -> IterRemove(B) -> [A]
	 * @return [A] after IterRemove(B)
	 */
	...
	/** Scenario: [ABC] -> IterRemove(A) -> [BC]
	 * @return [BC] after IterRemove(A)
	 */
	...
	/** Scenario: [ABC] -> IterRemove(B) -> [AC]
	 * @return [AC] after IterRemove(B)
	 */
	...
	/** Scenario: [ABC] -> IterRemove(C) -> [AB]
	 * @return [AB] after IterRemove(C)
	 */
	...
	/** Scenario: [ABC] -> iterRemove after iterNext -> [BC]
	 * @return [BC] after iterRemove after iterNext
	 */
	private IndexedUnsortedList<Integer> ABC_iterRemove_BC() {
		IndexedUnsortedList<Integer> list = BC_addToFrontA_ABC();
		Iterator<Integer> it = list.iterator();
		it.next();
		it.remove();
	...
	private Scenario<Integer> ABC_iterRemove_BC = () -> ABC_iterRemove_BC();
	...
	/** Scenario: [ABC] -> removeFirst() removeLast() -> [B]
	 * @return [B] after removeFirst() removeLast()
	 */
	private IndexedUnsortedList<Integer> ABC_removeFirst_removeLast_B() {
		IndexedUnsortedList<Integer> list = BC_addToFrontA_ABC();
		list.removeFirst();
		list.removeLast();
		return list;
	}
	private Scenario<Integer> ABC_removeFirst_removeLast_B = () -> ABC_removeFirst_removeLast_B();
	
	/** Scenario: [ABC] -> removeFirst() iterNext() iterRemove() -> [C]
	 * @return [C] after removeFirst() iterNext() iterRemove()
	 */
	private IndexedUnsortedList<Integer> ABC_removeFirst_iterRemove_C () {
		IndexedUnsortedList<Integer> list = BC_addToFrontA_ABC();
		list.removeFirst();
		Iterator<Integer> it = list.iterator();
		it.next();
	...
	private Scenario<Integer> ABC_removeFirst_iterRemove_C = () -> ABC_removeFirst_iterRemove_C();
	
	private IndexedUnsortedList<Integer> ABC_NextPreviousRemove_BC () {
		IndexedUnsortedList<Integer> list = BC_addToFrontA_ABC();
	...
	private Scenario<Integer> ABC_NextPreviousRemove_BC = () -> ABC_NextPreviousRemove_BC();
	
	private IndexedUnsortedList<Integer> ABC_NextNextSetD_ADC () {
		IndexedUnsortedList<Integer> list = BC_addToFrontA_ABC();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> ABC_NextNextSetD_ADC = () -> ABC_NextNextSetD_ADC();
	
	private IndexedUnsortedList<Integer> BA_NextNextSetC_BC () {
		IndexedUnsortedList<Integer> list = A_addToFrontB_BA();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> BA_NextNextSetC_BC = () -> BA_NextNextSetC_BC();
	
	private IndexedUnsortedList<Integer> B_NextAddA_BA () {
		IndexedUnsortedList<Integer> list = A_set0B_B();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.add(ELEMENT_A);
		return list;
	}
	private Scenario<Integer> B_NextAddA_BA = () -> B_NextAddA_BA();
	
	private IndexedUnsortedList<Integer> ABCD_remove3_ABC () {
		IndexedUnsortedList<Integer> list = ABCDList();
		list.remove(3);
		return list;
	}
	private Scenario<Integer> ABCD_remove3_ABC = () -> ABCD_remove3_ABC();
	
	private IndexedUnsortedList<Integer> ABC_NextNextPreviousRemove_AC() {
		IndexedUnsortedList<Integer> list = BC_addToFrontA_ABC();
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> ABC_NextNextPreviousRemove_AC = () -> ABC_NextNextPreviousRemove_AC();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			if (SUPPORTS_LIST_ITERATOR) {
			      ...
			      printTest(scenarioName + "_testListIterSet", testListIterSet(scenario.build().listIterator(), ELEMENT_X, Result.IllegalState));
			      printTest(scenarioName + "_testListIterNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 1), Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextRemove", testIterRemove(listIterAfterNext(listIterAfterNext(scenario.build().listIterator(), 1), 1), Result.NoException));
			      printTest(scenarioName + "_testListIterNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextAdd", testListIterAdd(listIterAfterNext(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));	
			      printTest(scenarioName + "_testListIterNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextSet", testListIterSet(listIterAfterNext(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), Result.IllegalState));
			      printTest(scenarioName + "_testListIterNextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(listIterAfterNext(scenario.build().listIterator(), 1), 1), 1), Result.NoException));
			      printTest(scenarioName + "_testListIterNextPreviousRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1)), Result.IllegalState));
			      printTest(scenarioName + "_testListIterNextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));			
			      printTest(scenarioName + "_testListIterNextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIter0HasNext", testIterHasNext(scenario.build().listIterator(0), Result.True));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testSet0", testSet(scenario.build(), 0, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testSet1", testSet(scenario.build(), 1, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testSet1", testSet(scenario.build(), 2, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testSet2", testSet(scenario.build(), 3, ELEMENT_X, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testAdd", testAdd(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testGetNeg1", testGet(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testGet0", testGet(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testGet1", testGet(scenario.build(), 1, contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testGet1", testGet(scenario.build(), 2, contents[2], Result.MatchingValue));
			printTest(scenarioName + "_testGet2", testGet(scenario.build(), 3, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testIndexOf" + contentsString.charAt(0), testIndexOf(scenario.build(), contents[0], 0));
			printTest(scenarioName + "_testIndexOf" + contentsString.charAt(1), testIndexOf(scenario.build(), contents[1], 1));
			printTest(scenarioName + "_testIndexOf" + contentsString.charAt(1), testIndexOf(scenario.build(), contents[2], 2));
			printTest(scenarioName + "_testIndexOfX", testIndexOf(scenario.build(), ELEMENT_X, -1));
			printTest(scenarioName + "_testRemoveNeg1", testRemoveIndex(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testRemove0", testRemoveIndex(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemove1", testRemoveIndex(scenario.build(), 1, contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testRemove1", testRemoveIndex(scenario.build(), 2, contents[2], Result.MatchingValue));
			...
			if (SUPPORTS_LIST_ITERATOR) {
			      ...
			      printTest(scenarioName + "_testListIterNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 1), Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextRemove", testIterRemove(listIterAfterNext(listIterAfterNext(scenario.build().listIterator(), 1), 1), Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextNextRemove", testIterRemove(listIterAfterNext(listIterAfterNext(listIterAfterNext(scenario.build().listIterator(), 1), 1), 1), Result.NoException));
			      printTest(scenarioName + "_testListIterNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextAdd", testListIterAdd(listIterAfterNext(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextNextAdd", testListIterAdd(listIterAfterNext(listIterAfterNext(listIterAfterNext(scenario.build().listIterator(), 1), 1), 1), ELEMENT_X, Result.NoException));	
			      printTest(scenarioName + "_testListIterNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextSet", testListIterSet(listIterAfterNext(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextNextSet", testListIterSet(listIterAfterNext(listIterAfterNext(listIterAfterNext(scenario.build().listIterator(), 1), 1), 1), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), Result.IllegalState));
			      printTest(scenarioName + "_testListIterNextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(listIterAfterNext(scenario.build().listIterator(), 1), 1), 1), Result.NoException));
			      printTest(scenarioName + "_testListIterNextPreviousRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1)), Result.IllegalState));
	...
	private void test_ListIterConcurrency() {
		...
		try {
			...
			it1 = list.listIterator();
			list.remove(0);
			printTest("A_remove0_testListIterPreviousIndexConcurrent", testListIterPreviousIndex(it1, -1, Result.ConcurrentModification));		} catch (Exception e) {
			System.out.printf("***UNABLE TO RUN/COMPLETE %s***\n", "test_ListIterConcurrency");
			e.printStackTrace();
		} finally {
			if (printSectionSummaries) {
